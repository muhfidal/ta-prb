...
<div class="container mx-auto px-4 py-8">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 space-y-4 md:space-y-0">
        <div class="space-y-2">
            <h2 class="text-2xl font-bold text-gray-800">Edit Penyakit</h2>
            <p class="text-gray-600">Perbarui informasi data penyakit dalam sistem</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        <div class="bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-4">
            <h3 class="text-lg font-semibold text-white flex items-center">
                <i class="fas fa-pen-to-square mr-2"></i> Form Edit Penyakit
            </h3>
        </div>

        <div class="p-6">
            <form action="{{ route('diseases.update', $disease) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <div class="relative rounded-md shadow-sm">
                            <textarea name="description"
                                      rows="4"
                                      class="block w-full rounded-lg border-gray-300 pl-4 pr-12 focus:ring-blue-500 focus:border-blue-500 text-gray-700"
                                      placeholder="Masukkan deskripsi penyakit">{{ old('description', $disease->description) }}</textarea>
